...
#include "../ngx_type.h"
	...
	#define NGX_ATOMIC_T_LEN            (sizeof("-2147483648") - 1)
		...
		#include "atomic/ngx_gcc_atomic_x86.h"
	...
	#define NGX_ATOMIC_T_LEN            (sizeof("-9223372036854775808") - 1)
		...
		#include "atomic/ngx_gcc_atomic_amd64.h"
	...
	typedef volatile ngx_atomic_uint_t  ngx_atomic_t;
		...
		#include "atomic/ngx_sunpro_atomic_sparc64.h"
		...
		#include "atomic/ngx_gcc_atomic_sparc64.h"
	...
	#include "atomic/ngx_gcc_atomic_ppc.h"
